document.addEventListener('DOMContentLoaded', function () {
    ...
    //--FUNCIONES------------------------------------
        function mostrarocultardatosexamenes() {
            ...
            actualizartablaexamenes();  //Actualizamos la tabla siempre que realicemos un cambio
        }
    //--------------------------------------
    
        function agregarusuarioexamenes() {     //Esta funcion llama a la api para guardar el usuario, creando y almacenando las propiedades de los datos que inteoducimos en los input.
            var nuevousuario = {
    ...
    //--------------------------------------
        ...
        function actualizartablaexamenes() {   //Con esta funcion generaremos la tabla en función a los datos que posea la base de datos, recibiendo estos a través de la API y generando a su vez los input para introducir usuarios
